...
public final class deleteborrower_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("                  ");
                 ...
                 int borrowerid=Integer.parseInt(request.getParameter("borrowerid"));
                   int a=db.deleteBorrower(borrowerid);
                      if(a>0)
                      {
                          out.print("deleted");
                      }
