...
public final class addtranscation_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("    <h1>ADD TRANSCATION</h1>\n");
      ...
      out.write("                  <tr><td>Borrower Name</td>\n");
      out.write("                    <td><input type=\"text\" name=\"borrowername\"></td></tr>\n");
      out.write("                  <tr><td>Borrower Id</td>\n");
      out.write("                    <td><input type=\"number\" name=\"borrowerid\"></td></tr>\n");
      out.write("                   <tr><td>Transcation Id</td>\n");
      out.write("                    <td><input type=\"number\" name=\"transcationid\"></td></tr>\n");
      out.write("                  <tr><td>Due Date</td>\n");
      out.write("                    <td><input type=\"number\" name=\"duedate\"></td></tr>\n");
      out.write("                  <tr><td>Return Date</td>\n");
      out.write("                    <td><input type=\"number\" name=\"returndate\"></td></tr>\n");
      out.write("                  \n");
      out.write("                  <tr><td><input type=\"submit\" value=\"AddBooks\"></td></tr>\n");
      out.write("                  ");
                  ...
                  catch(Exception e)
{
    out.print("not inserted with error"+e.getMessage());
      ...
      out.write("                  \n");
      out.write("                  <div>\n");
      out.write("                      <p>Available Transcation</p>\n");
      out.write("                      ");
      ...
      out.write("                          <tr><th>Book Id</th><th>Title</th><th>Borrower Name</th><th>Borrower Id</th><th>Transcation Id</th><th>Borrow Date</th><th>Due Date</th><th>Return Date</th></tr>\n");
      out.write("                          ");
      ...
      out.write("                          <tr>\n");
      out.write("                              <td>");
      out.print(da.getBookid());
      out.write("</td>\n");
      out.write("                               <td>");
      out.print(da.getTitle());
      out.write("</td>\n");
      out.write("                                  <td>");
      ...
      out.write("</td>\n");
      out.write("                                  <td>");
      out.print(da.getTranscationid());
      out.write("</td>\n");
      out.write("                                  <td>");
      out.print(da.getBorrowdate());
      out.write("</td>\n");
      out.write("                                  <td>");
      out.print(da.getDuedate());
      out.write("</td>\n");
      out.write("                                  <td>");
      out.print(da.getReturndate());
      out.write("</td>\n");
      out.write("                              \n");
      out.write("                          </tr>\n");
      out.write("                          ");
